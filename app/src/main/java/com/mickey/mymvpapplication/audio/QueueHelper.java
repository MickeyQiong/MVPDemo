...
public class QueueHelper {
     ...
     * 获取正在播放的队列
     */
    public static List<MediaSessionCompat.QueueItem> getPlayingQueue(AudioProvider musicProvider) {
     ...
     */
    public static List<MediaSessionCompat.QueueItem> getRandomQueue(AudioProvider musicProvider) {
